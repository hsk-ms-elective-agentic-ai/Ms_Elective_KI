...
| [3 — Single Agent](../../exercises/en/step_03_05_agents.ipynb) | The CrewAI framework loop *(interim submission due)* |
| [4 — Multi-Agent](../../exercises/en/step_03_05_agents.ipynb) | Role specialization + task chaining |
| [5 — RAG + Tools](../../exercises/en/step_03_05_agents.ipynb) | External grounding: web search + document retrieval *(final submission due)* |
