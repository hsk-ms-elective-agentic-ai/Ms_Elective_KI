...
| Ethik-Report | 20% | **Individuell** | Euer eigener [`ethics-report-template.md`](ethics-report-template.md), eingereicht über OpenOlat, nicht über GitHub (siehe Abgabepaket oben). Beurteilt euren Agenten anhand des EU-Rahmens für vertrauenswürdige KI — bewertet danach, wie spezifisch und ehrlich er sich mit jeder Dimension auseinandersetzt, verankert im tatsächlichen Agenten eures Teams und euren eigenen Beobachtungen, sowie anhand der konkreten Änderungen, die ihr zur Verbesserung der Vertrauenswürdigkeit vorschlagt — nicht generisch. Auf dem offiziellen Bewertungsbogen als "Schriftliche Ausarbeitung" geführt. |
