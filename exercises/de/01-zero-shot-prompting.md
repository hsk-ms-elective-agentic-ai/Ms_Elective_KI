...
🇩🇪 **Deutsch** (diese Seite) · 🇬🇧 [English](../en/step_01_zero_shot_prompting.ipynb)

**Hinweis:** Dieser Schritt ist jetzt ein Jupyter-Notebook (auf Englisch) statt eines Python-Skripts — siehe [step_01_zero_shot_prompting.ipynb](../en/step_01_zero_shot_prompting.ipynb). Diese Seite beschreibt weiterhin Hintergrund und Aufgabe auf Deutsch; die deutsche Notebook-Version folgt noch.
...
Öffnet [step_01_zero_shot_prompting.ipynb](../en/step_01_zero_shot_prompting.ipynb) in VS Code/Cursor und wählt den Kernel **"research_crew"** (siehe Haupt-README, Abschnitt "Register the Jupyter kernel"). Die Code-Zelle:
