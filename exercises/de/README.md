...
| [3](../en/step_03_single_agent.ipynb) | Einzelner Agent | Ein eigenständiger `Agent`, kein Framework-Projekt nötig *(Zwischenabgabe fällig)* |
| [4](../en/step_04_multi_agent.ipynb) | Multi-Agent | Zwei Agenten, verkettet durch Weitergabe der Ausgabe |
| [5](../en/step_05a_tools.ipynb) | Tools, MCP & RAG | Websuche, ein MCP-Server und eine Knowledge-Source (3 Notebooks) *(Abschlussabgabe fällig)* |
