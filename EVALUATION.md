...
> [exercises/en/01-simple-prompting.md](exercises/en/01-simple-prompting.md)) for what
...
deploy, and why? What would you lose by going one step simpler? What would you gain by
going one step more complex — and is that gain worth the added fragility?
